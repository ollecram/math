...
Ora identifichiamo ciascun elemento $a \in \mathcal Z$ con una funzione  $f_{a} : \mathcal Z \mapsto \mathcal Z$ tale che per ogni $x \in \mathcal Z$ valga $f_{a}(x) = x + a$. Per la pr
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyNzI2MjU4LC0zMTYzMjk3OTYsLTE3Mj
I4OTM2MjgsLTM4MTYwNTg5NywtMTMyNzE3NTEyMCwtODY4NDM4
Nzk4LC04Njg0Mzg3OThdfQ==
-->