...
La composizione di due funzioni è un esempio di *operazioni binaria*: una funzione che dall'insieme prodotto $Sche godono della proprietà associativa. 
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyMjk3MTQ2XX0=
-->