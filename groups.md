...
Questo risultato indica che l'identificazione $a \leftrightarrow f_{a}$ di un elementè consistente con l'assioma che  
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzY1ODI2NTc5LDkzMTA2ODUwOCwtMTcxMj
