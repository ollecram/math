...
La composizione di due funzioni è un esempio di *operazioni binaria*: una funzione definita sull'insieme prodotto $S\times S$ a valori in $S$.  
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY0MDk0NzY4LDE5NjAxNjg1MDZdfQ==
-->