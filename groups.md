...
La composizione di due funzioni è un esempio di *operazioni binaria*: una funzione che dall'insieme prodotto $S\tiche godono della proprietà associativa. 
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4MjM3MjY0NSwxOTYwMTY4NTA2XX0=
-->