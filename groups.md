...
In effetti capita in diversi contesti di definire una certa operazione $\diamond$ in un insieme $A$ e di chiedersi se per $a, b, c \in A$ valga per tale operazione la proprietà associativa:
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA3ODIwNDM4NCw4MjIwNjczNzMsLTUwNT
