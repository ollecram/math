...
$$ h \circ (g \circ f) = h(g(f(x))) =(h \circ g) \circ f $$
 ...
 Una funzione definita sull'insieme prodotto $S\times S$ a valori in $S$ si dice . In un certo senso La composizione di due funzioni è un esempio di
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ0OTMxNDM3NCwtMTM0ODgxMjE2OSwxOT
YwMTY4NTA2XX0=
-->