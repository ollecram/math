...
In un certo senso la operazione di composizione tra funzioni è il prototipo di tutte le *operazioni binarie* che godono della proprietà associativa. 
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY2Njc2Njg1MV19
-->