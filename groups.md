...
### Sottogruppi ###
Un sottoinsieme $H$ di un gruppo $G$ è un **sottogruppo** di $G$ se esso è un gruppo rispetto alla medesima operazione binaria. Ciò 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDkwOTIwMDIsLTE5OTAwMTU3MjAsOD
