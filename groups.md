...
Se ora identifichiamo ciascun elemento $x \in \mathcal Z$ con una funzione  $f_{x} : \mathcal Z \mapsto \mathcal Z$
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyMTA2NjQzOCwtMTcyMjg5MzYyOCwtMz
