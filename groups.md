...
### Sottogruppi ###
Un sottoinsieme $H$ di un gruppo $G$ è un **sottogruppo** di $G$ se esso è un gruppo rispetto alla medesima operazione binaria. Cio
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODExOTYyMTgxLC0xOTkwMDE1NzIwLDg2OD
