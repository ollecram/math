...
Identifichiamo ora ciascun elemento $a \in \mathcal Z$ con una funzione  $f_{a} : \mathcal Z \mapsto \mathcal Z$ tale che per ogni $x \in \mathcal Z$ valga $f_{a}(x) = x + a$. Da questa identificazione discendIn virtù della proprietà associativa della composizione di funzioni otteniamo:
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MjM3NjQ5OTYsLTIyNTg1NDgyN119
-->