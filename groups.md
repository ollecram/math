...
In ogni gruppo l'elemento identità è unico ed ogni elemento ha un unico inverso. Inoltre, se se $g \in G$ allora ${(g^{-1})}^{-1}$
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1Njg3MTcyMzIsMTY0ODQ1NzQ1OCwxMj
I0NDQ0MzkwLDE3MDA3MDkyOTldfQ==
-->