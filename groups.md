...
La composizione di due funzioni è un esempio di *operazioni binaria*: una funzione che dall'insieme prodotto $S\timesSche godono della proprietà associativa. 
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg4NjY2OTUxNywxOTYwMTY4NTA2XX0=
-->