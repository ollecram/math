...
$$ h \circ (g \circ f) = h(g(f(x))) =(h \circ g) \circ f $$
 ...
 Una funzione definita sull'insieme prodotto $S\times S$ a valori in $S$ si di. In un certo senso La composizione di due funzioni è un esempio di
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAwODY5NTA4LC0xMzQ4ODEyMTY5LDE5Nj
AxNjg1MDZdfQ==
-->