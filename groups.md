...
In effetti capita in diversi contesti di definire una certa operazione $\diamond$ in un insieme $A$ e di chiedersi se per $a, b, c \in tale operazione valga la proprietà associativa:
...
$$ \sqrt{x^2} = x $$  
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDk1Mzg3NDgyLDgyMjA2NzM3MywtNTA1MD
